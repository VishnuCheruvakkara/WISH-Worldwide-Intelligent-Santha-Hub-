...
const Navbar = () => {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex items-center justify-between backdrop-blur-md bg-santa-navy-dark/80 border-b border-white/5">
            ...
            <div className="flex items-center gap-8">
                ...
                <Link to="/story" className="text-gray-300 hover:text-white transition-colors">Story</Link>
            </div>
